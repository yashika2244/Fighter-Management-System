...
// const API_BASE = "http://localhost:5000/api"; // <-- backend ka URL
...
//       if (onSave) onSave(res.data); // <-- update table
//       onClose();
//     } catch (err) {
...
//       focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
//     />
//   </div>
// );
    ...
    <div className="fixed inset-0 bg-transparent/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white w-[950px] max-h-[90vh] rounded-lg shadow-2xl overflow-hidden flex flex-col border border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-gray-50/30">
          ...
          {activeTab === "Contact" && (
            <div className="h-[335px] overflow-y-auto p-4 bg-gray-50 rounded">
              <Field label="Mobile Number" name="mobileNo" value={form.mobileNo || ""} onChange={handleChange} icon={<Phone className="w-4 h-4 text-gray-500" />} />
            </div>
          )}
          ...
          {activeTab === "Medical" && (
            <div className="h-[335px] grid grid-cols-2 gap-6">
              <Field label="Blood Group" name="bg" value={form.bg || ""} onChange={handleChange} icon={<HeartPulse className="w-4 h-4 text-red-500" />} />
          ...
          {activeTab === "Service" && (
            <div className="h-[335px] grid grid-cols-2 gap-6">
              ...
              <Field label="JD Pet 2nd" name="jdpet2st" value={form.jdpet2st || ""} onChange={handleChange} />
